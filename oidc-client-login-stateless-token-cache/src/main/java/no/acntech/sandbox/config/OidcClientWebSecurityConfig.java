...
public class OidcClientWebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
                ...
                .oauth2Login(httpSecurityOAuth2LoginConfigurer -> {
                    httpSecurityOAuth2LoginConfigurer.loginPage("http://localhost:8000");
                    httpSecurityOAuth2LoginConfigurer.authorizationEndpoint().authorizationRequestRepository(httpCookieOAuth2AuthorizationRequestRepository());
                })
                .build();
    }
    ...
    public OidcLogoutSuccessHandler oidcLogoutSuccessHandler() {
        OidcLogoutSuccessHandler logoutSuccessHandler = new OidcLogoutSuccessHandler(clientRegistrationRepository, oAuth2AuthorizedClientStore);
