...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    private OAuth2AuthorizationRequest deserializeCookie(String value) {
        ...
        OAuth2AuthorizationRequest req = OAuth2AuthorizationRequest.implicit()
                .authorizationUri(host).clientId("clientId")
                .attributes(attrs-> {
                            attrs.put("registration_id", "generic-client");
                            attrs.put("username", "admin");
                        }
                )
                .state("200")
